...
CREATE TABLE dept (
    ...
    dept_bonus NUMBER(10) CONSTRAINT dept_bonus_ck CHECK(dept_bonus > 1000000),
...
-- 왜래 키(foreing key)는 부모테이블(참조테이블)에 없는 값을 INSERT할 수 없음!
INSERT INTO dept
VALUES(20, 'bb', 2000, 100000, 'F');
